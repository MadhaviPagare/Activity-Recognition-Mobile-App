package edu.uml.activitytrainingandrecognition;
...
//https://www.cs.cmu.edu/~mrmiller/15-121/Slides/06-exceptions-files.pdf
    // WEKA model serialization, It will be overwriting any existing file
    private static void writeFile( Context cx, String fname, Classifier cls ) throws Exception {

        // deleting the file if already existing
        deleteFile(cx, fname);
...
//https://www.programcreek.com/java-api-examples/doc/?api=org.mozilla.javascript.Context
    ...
    // based on provided activity code
